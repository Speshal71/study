...
const dis_t MAX_SEARCH_CAPACITY = 32768;
const char TERM = '\0';
...
public:
    ...
    std::map<std::pair<bool, char>, uint32_t> Encode(char const *from, char const *to);
    void Decode(char const *from, char const *to);
